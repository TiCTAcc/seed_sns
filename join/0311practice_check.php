...
if ($_POST['action']== 'submit') {
  $sql_insert='INSERT INTO `members` SET `nick_name`=?, `email`=?, `password`=?, `picture_path`=?';
  $data_insert=array($_SESSION['join']['nick_name'],$_SESSION['join']['email'],sha1($_SESSION['join']['password']),$_SESSION['join']['picture_path']);
...
header('Location: 0311practice_thanks.php');
